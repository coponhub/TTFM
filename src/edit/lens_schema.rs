...
pub(crate) fn item_ref_row(item_id: i64, item_kind: String, content: String) -> ItemRefRow {
    ItemRefRow {
...
pub(crate) fn user_tags_row(item_id: i64, tag_type: String, value: LabelValue) -> UserTagsRow {
...
pub fn label_value_to_eav_columns(
    ...
    match v {
        LabelValue::String(s) | LabelValue::Literal(s) => (Some(s), None, None, None),
        LabelValue::Integer(i) => (None, Some(i), None, None),
        LabelValue::Double(bits) => (None, None, Some(f64::from_bits(bits)), None),
